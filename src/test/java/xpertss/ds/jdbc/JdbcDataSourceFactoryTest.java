...
public class JdbcDataSourceFactoryTest {
   ...
   public void setUp()
   {
      objectUnderTest = new JdbcDataSourceFactory();
   ...
   public void testCreatesOriginDataSource() throws Exception
   {
      ...
      ref.add(new StringRefAddr(JdbcDataSource.URL, "jdbc:test://localhost/none"));
   ...
   {
      Reference ref = new Reference(JdbcDataSource.class.getName());
      ref.add(new StringRefAddr(JdbcDataSource.URL, "test"));
      ...
      assertEquals("test", result.getProperty(JdbcDataSource.URL));
